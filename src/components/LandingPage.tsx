  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#ef8508] via-[#b5593d] to-[#323232] text-white flex flex-col items-center justify-center px-6">
      <motion.h2
        ...
        className="text-7xl font-bold text-center mb-12 text-black"
      >
        SolEstate
      </motion.h2>
      ...
      <motion.h1
        ...
        animate={{ opacity: 1, y: 0 }}
        transition={{ duration: 1, delay: 0.1 }}
        className="text-5xl font-extrabold text-center mb-2 mt-8 text-black"
      >
      ...
      <motion.p
        ...
        className="text-xl mt-4 max-w-2xl text-center mb-4 text-black"
      >
